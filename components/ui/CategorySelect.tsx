...
const fallbackCategories: TaskCategory[] = [ 
  { id: "c1", name: "Engineering", color: "bg-primary" },
  { id: "c2", name: "Design", color: "bg-accent-verdant" },
  { id: "c3", name: "Marketing", color: "bg-accent-earth" },
];
...
export function CategorySelect({ value, onChange }: CategorySelectProps) {
  ...
  return (
    <Popover className="relative w-full">
      <PopoverButton className="flex w-full items-center justify-between bg-surface-standard/5 border border-outline/10 rounded-xl px-3 py-2.5 focus:outline-none focus:border-primary/50 transition-colors">
